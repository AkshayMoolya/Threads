...
import { fetchNotifications, fetchReplyNotifications } from "@/lib/actions/notification.actions";
...
async function Page() {
  ...
  const notifications = await fetchReplyNotifications({ userId: userInfo._id });
